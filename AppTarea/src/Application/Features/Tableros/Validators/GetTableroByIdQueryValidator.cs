...
{
    public class GetTableroByIdQueryValidator : AbstractValidator<GetTableroByIdQuery>
    {
        private readonly ITableroRepository _tableroRepository;

        public GetTableroByIdQueryValidator(ITableroRepository tableroRepository)
        {
